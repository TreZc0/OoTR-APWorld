...
item_table = {
    ...
    'Fairy Drop':                                      ('Item',     None,  0x0119, {'market_price': 50}),
    ...
    'Minuet of Forest':                 ('Song',     True,  0xBB, { 'text_id': 0x73, 'song_id': 0x02, 'item_id': 0x5A, }),
    'Bolero of Fire':                   ('Song',     True,  0xBC, { 'text_id': 0x74, 'song_id': 0x03, 'item_id': 0x5B, }),
    'Serenade of Water':                ('Song',     True,  0xBD, { 'text_id': 0x75, 'song_id': 0x04, 'item_id': 0x5C, }),
    'Requiem of Spirit':                ('Song',     True,  0xBE, { 'text_id': 0x76, 'song_id': 0x05, 'item_id': 0x5D, }),
    'Nocturne of Shadow':               ('Song',     True,  0xBF, { 'text_id': 0x77, 'song_id': 0x06, 'item_id': 0x5E, }),
    'Prelude of Light':                 ('Song',     True,  0xC0, { 'text_id': 0x78, 'song_id': 0x07, 'item_id': 0x5F, }),
    'Zeldas Lullaby':                   ('Song',     True,  0xC1, { 'text_id': 0xD4, 'song_id': 0x0A, 'item_id': 0x60, }),
    'Eponas Song':                      ('Song',     True,  0xC2, { 'text_id': 0xD2, 'song_id': 0x09, 'item_id': 0x61, }),
    'Sarias Song':                      ('Song',     True,  0xC3, { 'text_id': 0xD1, 'song_id': 0x08, 'item_id': 0x62, }),
    'Suns Song':                        ('Song',     True,  0xC4, { 'text_id': 0xD3, 'song_id': 0x0B, 'item_id': 0x63, }),
    'Song of Time':                     ('Song',     True,  0xC5, { 'text_id': 0xD5, 'song_id': 0x0C, 'item_id': 0x64, }),
    'Song of Storms':                   ('Song',     True,  0xC6, { 'text_id': 0xD6, 'song_id': 0x0D, 'item_id': 0x65, }),
    ...
    'Kokiri Emerald':                   ('DungeonReward',    True,  None, { 'stone': True, 'addr2_data': 0x80, 'bit_mask': 0x00040000, 'item_id': 0x6C, 'gi_id': 0x127, 'actor_type': 0x13, 'object_id': 0x00AD, }),
    'Goron Ruby':                       ('DungeonReward',    True,  None, { 'stone': True, 'addr2_data': 0x81, 'bit_mask': 0x00080000, 'item_id': 0x6D, 'gi_id': 0x128, 'actor_type': 0x14, 'object_id': 0x00AD, }),
    'Zora Sapphire':                    ('DungeonReward',    True,  None, { 'stone': True, 'addr2_data': 0x82, 'bit_mask': 0x00100000, 'item_id': 0x6E, 'gi_id': 0x129, 'actor_type': 0x15, 'object_id': 0x00AD, }),
    'Forest Medallion':                 ('DungeonReward',    True,  None, { 'medallion': True, 'addr2_data': 0x3E, 'bit_mask': 0x00000001, 'item_id': 0x66, 'gi_id': 0x12B, 'actor_type': 0x0B, 'object_id': 0x00BA, }),
    'Fire Medallion':                   ('DungeonReward',    True,  None, { 'medallion': True, 'addr2_data': 0x3C, 'bit_mask': 0x00000002, 'item_id': 0x67, 'gi_id': 0x12C, 'actor_type': 0x09, 'object_id': 0x00BA, }),
    'Water Medallion':                  ('DungeonReward',    True,  None, { 'medallion': True, 'addr2_data': 0x3D, 'bit_mask': 0x00000004, 'item_id': 0x68, 'gi_id': 0x12D, 'actor_type': 0x0A, 'object_id': 0x00BA, }),
    'Spirit Medallion':                 ('DungeonReward',    True,  None, { 'medallion': True, 'addr2_data': 0x3F, 'bit_mask': 0x00000008, 'item_id': 0x69, 'gi_id': 0x12F, 'actor_type': 0x0C, 'object_id':  0x00BA, }),
    'Shadow Medallion':                 ('DungeonReward',    True,  None, { 'medallion': True, 'addr2_data': 0x41, 'bit_mask': 0x00000010, 'item_id': 0x6A, 'gi_id': 0x12E, 'actor_type': 0x0D, 'object_id': 0x00BA, }),
    'Light Medallion':                  ('DungeonReward',    True,  None, { 'medallion': True, 'addr2_data': 0x40, 'bit_mask': 0x00000020, 'item_id': 0x6B, 'gi_id': 0x12A, 'actor_type': 0x0E, 'object_id': 0x00BA, }),
}
